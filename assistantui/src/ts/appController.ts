...
class RootViewModel {
  ...
  constructor() {
    ...
    const navData = [
      ...
      { path: "question", detail: { label: "Question", iconClass: "oj-ux-ico-annotation" } },
      { path: "action", detail: { label: "Actions", iconClass: "oj-ux-ico-fire" } }
    ];
    // router setup
    ...
    this.appName = ko.observable("AutoBot");
      ...
      if (darkContainer != null) {
        if (newValue) {
          darkContainer.className =
            "oj-panel oj-bg-neutral-170 oj-color-invert";
        } else {
